    ...
    <div class="main-container">
        <div class="xs-pd-20-10 pd-ltr-20">
            <div class="pb-20 title">
                <h2 class="mb-0 h3">Hospital Overview</h2>
            </div>
            ...
            <div class="pb-10 row">
                ...
                <div class="mb-20 col-md-4">
                    <div class="mb-20 card-box min-height-200px pd-20" data-bgcolor="#455a64">
            ...
            <div class="row">
                <div class="mb-20 col-lg-4 col-md-6">
                    <div class="card-box height-100-p pd-20 min-height-200px">
                        <div class="pb-10 d-flex justify-content-between">
                            <div class="mb-0 h5">Top Doctors</div>
                            <div class="dropdown">
                        ...
                        <div class="user-list">
                            <ul>
                                <li class="d-flex align-items-center justify-content-between">
                                    <div class="pr-2 name-avatar d-flex align-items-center">
                                        <div class="flex-shrink-0 mr-2 avatar">
                                            <img src="{{ asset('public/admin/assets/vendors') }}/images/photo1.jpg"
                                ...
                                <li class="d-flex align-items-center justify-content-between">
                                    <div class="pr-2 name-avatar d-flex align-items-center">
                                        <div class="flex-shrink-0 mr-2 avatar">
                                            <img src="{{ asset('public/admin/assets/vendors') }}/images/photo2.jpg"
                                                class="border-radius-100 box-shadow" width="50" height="50" alt="" />
                                        </div>
                                        <div class="txt">
                                            <span class="badge badge-pill badge-sm" data-bgcolor="#e7ebf5"
                                ...
                                <li class="d-flex align-items-center justify-content-between">
                                    <div class="pr-2 name-avatar d-flex align-items-center">
                                        <div class="flex-shrink-0 mr-2 avatar">
                                            <img src="{{ asset('public/admin/assets/vendors') }}/images/photo3.jpg"
                                                class="border-radius-100 box-shadow" width="50" height="50" alt="" />
                                        </div>
                                        <div class="txt">
                                            <span class="badge badge-pill badge-sm" data-bgcolor="#e7ebf5"
                                ...
                                <li class="d-flex align-items-center justify-content-between">
                                    <div class="pr-2 name-avatar d-flex align-items-center">
                                        <div class="flex-shrink-0 mr-2 avatar">
                                            <img src="{{ asset('public/admin/assets/vendors') }}/images/photo4.jpg"
                                                class="border-radius-100 box-shadow" width="50" height="50" alt="" />
                                        </div>
                                        <div class="txt">
                                            <span class="badge badge-pill badge-sm" data-bgcolor="#e7ebf5"
                ...
                <div class="mb-20 col-lg-4 col-md-6">
                    <div class="card-box height-100-p pd-20 min-height-200px">
                        <div class="d-flex justify-content-between">
                            <div class="mb-0 h5">Diseases Report</div>
                            <div class="dropdown">
                                <a class="p-0 btn btn-link font-24 line-height-1 no-arrow dropdown-toggle"
                                    data-color="#1b3133" href="#" role="button" data-toggle="dropdown">
                                    <i class="dw dw-more"></i>
                ...
                <div class="mb-20 col-lg-4 col-md-12">
                    <div class="card-box height-100-p pd-20 min-height-200px">
                        <div class="mx-auto max-width-300">
                            <img src="{{ asset('public/admin/assets/vendors') }}/images/upgrade.svg" alt="" />
                        </div>
                        <div class="text-center">
                            <div class="mb-1 h5">Upgrade to Pro</div>
                            <div class="pb-20 mx-auto font-14 weight-500 max-width-200" data-color="#a6a6a7">
            ...
            <div class="pb-10 card-box">
                <div class="mb-0 h5 pd-20">Recent Patient</div>
                    ...
                    <tbody>
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="flex-shrink-0 mr-2 avatar">
                                        <img src="{{ asset('public/admin/assets/vendors') }}/images/photo4.jpg"
                                            class="shadow border-radius-100" width="40" height="40" alt="" />
                                    </div>
                                    <div class="txt">
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="flex-shrink-0 mr-2 avatar">
                                        <img src="{{ asset('public/admin/assets/vendors') }}/images/photo5.jpg"
                                            class="shadow border-radius-100" width="40" height="40" alt="" />
                                    </div>
                                    <div class="txt">
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="flex-shrink-0 mr-2 avatar">
                                        <img src="{{ asset('public/admin/assets/vendors') }}/images/photo6.jpg"
                                            class="shadow border-radius-100" width="40" height="40" alt="" />
                                    </div>
                                    <div class="txt">
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="flex-shrink-0 mr-2 avatar">
                                        <img src="{{ asset('public/admin/assets/vendors') }}/images/photo9.jpg"
                                            class="shadow border-radius-100" width="40" height="40" alt="" />
                                    </div>
                                    <div class="txt">
                        ...
                        <tr>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="flex-shrink-0 mr-2 avatar">
                                        <img src="{{ asset('public/admin/assets/vendors') }}/images/photo8.jpg"
                                            class="shadow border-radius-100" width="40" height="40" alt="" />
                                    </div>
                                    <div class="txt">
            ...
            <div class="row">
                <div class="mb-20 col-md-4">
                    <a href="#" class="mx-auto card-box d-block pd-20 text-secondary">
                        <div class="img pb-30">
                            <img src="{{ asset('public/admin/assets/vendors') }}/images/medicine-bro.svg" alt="" />
                        </div>
                        <div class="content">
                ...
                <div class="mb-20 col-md-4">
                    <a href="#" class="mx-auto card-box d-block pd-20 text-secondary">
                        <div class="img pb-30">
                            <img src="{{ asset('public/admin/assets/vendors') }}/images/remedy-amico.svg" alt="" />
                        </div>
                        <div class="content">
                ...
                <div class="mb-20 col-md-4">
                    <a href="#" class="mx-auto card-box d-block pd-20 text-secondary">
                        <div class="img pb-30">
                            <img src="{{ asset('public/admin/assets/vendors') }}/images/paper-map-cuate.svg" alt="" />
                        </div>
                        <div class="content">
