        ...
        <div class="pd-20 card-box mb-30">
            <div class="clearfix">
                <div class="my-2 pull-left">
                    <h4 class="text-blue h4">Create Exam</h4>
                </div>
            </div>
            <form action="{{ route('admin.exam.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control" name="exam_name" type="text" required />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-12 col-md-2 col-form-label">Exam Year</label>
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control" name="exam_year" type="text"  />
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control" name="position_date" type="date" value="" />
                    </div>
                </div>
