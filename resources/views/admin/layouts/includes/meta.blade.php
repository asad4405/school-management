...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('public/admin/assets/src') }}/plugins/datatables/css/dataTables.bootstrap4.min.css" />
    <link rel="stylesheet" type="text/css"
        href="{{ asset('public/admin/assets/src') }}/plugins/datatables/css/responsive.bootstrap4.min.css" />
