...
@section('title') Student Lists @endsection
@section('content')
        ...
        <div class="pd-20 card-box mb-30">
            <div class="clearfix">
                <div class="my-2 pull-left">
                    <h4 class="text-blue h4">Student Lists</h4>
                </div>
                <div class="pull-right">
                    <a href="{{ route('admin.student.create') }}" class="btn btn-primary btn-sm scroll-click"><i
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" style="gap:6px;">
                                        <a href="{{ route('admin.student.edit', $value->id) }}" class="p-0 m-0">
                                            <i class="dw dw-edit2 bg-primary p-2 text-white rounded"></i>
                                        </a>

                                        <form action="{{ route('admin.student.destroy', $value->id) }}" method="POST"
