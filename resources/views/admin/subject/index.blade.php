...
@section('title') Subject Lists @endsection
@section('content')
        ...
        <div class="pd-20 card-box mb-30">
            <div class="clearfix">
                <div class="my-2 pull-left">
                    <h4 class="text-blue h4">Subject Lists</h4>
                </div>
                <div class="pull-right">
                    <a href="{{ route('admin.subject.create') }}" class="btn btn-primary btn-sm scroll-click"><i
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" style="gap:6px;">
                                        <a href="{{ route('admin.subject.edit', $value->id) }}" class="p-0 m-0">
