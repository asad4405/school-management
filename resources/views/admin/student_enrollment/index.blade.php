        ...
        <div class="pd-20 card-box mb-30">
            <div class="clearfix">
                <div class="my-2 pull-left">
                    <h4 class="text-blue h4">Student Enrollment Lists</h4>
                </div>
                <div class="pull-right">
                    <a href="{{ route('admin.student.enrollment.create') }}" class="btn btn-primary btn-sm scroll-click"><i
            ...
            <div class="pb-20">
                <table class="table data-table stripe hover nowrap">
                    ...
                    <tbody>
                        @foreach ($stuent_enrollments as $value)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" style="gap:6px;">
                                        <a href="{{ route('admin.student.enrollment.edit', $value->id) }}" class="p-0 m-0">
                                            <i class="dw dw-edit2 bg-primary p-2 text-white rounded"></i>
                                        </a>

                                        <form action="{{ route('admin.student.enrollment.destroy', $value->id) }}" method="POST"
