                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
                        <div class="pd-20 card-box height-100-p">
                            <div class="profile-photo">
                                ...
                                <img src="{{ asset('public/teacher/assets/vendors') }}/images/photo1.jpg" alt=""
                                    class="avatar-photo" />
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-body pd-5">
                                                <div class="img-container">
                                                    <img id="image"
                                                        src="{{ asset('public/teacher/assets/vendors') }}/images/photo2.jpg"
                                                        alt="Picture" />
                                                </div>
                                            </div>
                            ...
                            <h5 class="text-center h5 mb-0">{{ $teacher->teacher->name }}</h5>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade height-100-p" id="setting" role="tabpanel">
                                            <div class="profile-setting">
                                                <form action="{{ route('teacher.profile.update', $teacher->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    <ul class="profile-edit-list row">
                                                        <li class="weight-500 col-md-12">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input value="{{ $teacher->teacher->name }}"
                                                                    class="form-control form-control-lg" name="name"
                                                                    type="text" />
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Designation</label>
                                                                <input value="{{ $teacher->designation }}"
                                                                    name="designation" class="form-control form-control-lg"
                                                                    type="text" readonly />
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Email</label>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input value="{{ $teacher->dob }}" name="dob"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input name="phone" value="{{ $teacher->teacher->phone }}"
                                                            ...
                                                            <div class="form-group">
                                                                <label>Nid</label>
                                                                <input name="nid" value="{{ $teacher->nid }}"
